    ...
    if (tableBody) {
        tableBody.addEventListener('click', function (e) {
            ...
            if (deleteBtn) {
                ...
                showConfirmationDialog(`Delete customer "${customerName}"?`, async () => {
                    try {
                        const response = await fetch(`/extrusions/api/customers/${customerId}/`, {
                            method: 'DELETE',
                            headers: {
                        ...
                        if (result.success) {
                            ...
                            alert(result.message || "Failed to delete customer. Try again!");
                        }
                    } catch (err) {
                        console.error(err);
