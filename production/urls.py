...
urlpatterns = [
    ...
    path('online-production-report/list/', OnlineProductionReportListView.as_view(), name='online_production_report_list'),
    path('daily-production-report/', DailyProductionReportView.as_view(), name='daily_production_report'),
