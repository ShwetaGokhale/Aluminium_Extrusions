"""
Django settings for Aluminium_Extrusions project.
...
SECRET_KEY = 'django-insecure-rg%7chs!k_*ch^4-hc197((gf6j+5fq@6#sp(54qu$7-tp8mw&'
...
ROOT_URLCONF = 'Aluminium_Extrusions.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [TEMP_DIR],  # Use TEMP_DIR for templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Aluminium_Extrusions.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'root',
        'NAME': 'ExtrusionsDB',  # Use a more descriptive name for the database
    }
}
...
STATIC_URL = '/static/'  # Important for FORCE_SCRIPT_NAME
